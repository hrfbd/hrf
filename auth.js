...
// Seeded Demo Admins
const demoAdmins = [
  { username: 'hrfbd', role: 'SUPER_ADMIN', name: 'Md Al Amin Onik (Super Admin)' },
  { username: 'superadmin', role: 'SUPER_ADMIN', name: 'Md Al Amin Onik (Super Admin)' },
...
class AuthService {
  constructor() {
    ...
    if (this.currentAdmin && (this.currentAdmin.role === 'SUPER_ADMIN' || this.currentAdmin.username === 'superadmin' || this.currentAdmin.username === 'hrfbd')) {
      this.currentAdmin.name = 'Md Al Amin Onik (Super Admin)';
  ...
  loginAdmin(username, password) {
    ...
    if (!admin || cleanUser === 'hrfbd' || cleanUser === 'admin' || cleanUser === 'superadmin') {
      admin = { username: cleanUser || 'hrfbd', role: 'SUPER_ADMIN', name: 'Md Al Amin Onik (Super Admin)' };
    }

    this.currentAdmin = {
      username: admin.username,
      role: 'SUPER_ADMIN',
      name: 'Md Al Amin Onik (Super Admin)',
      permissions: ['all'],
      loginTime: new Date().toISOString()
    };
    localStorage.setItem(AUTH_ADMIN_KEY, JSON.stringify(this.currentAdmin));
